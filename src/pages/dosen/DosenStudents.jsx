    ...
    <div className="space-y-6">
      ...
      <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-6 border border-gray-200/50">
        <div>
          ...
          <p className="text-gray-600">Daftar semua mahasiswa dari kelas yang Anda ajar</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl shadow-lg p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-purple-100 text-sm mb-1">Ditampilkan</p>
        ...
        <div className="grid gap-4">
          {filteredStudents.map((student) => (
            <div
              ...
              className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-6 border border-gray-200/50 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300"
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-gray-900">{student.nama_lengkap}</h3>
                      <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 mt-1">
                        <div className="flex items-center gap-2">
                          <Hash className="h-4 w-4" />
                          <span>NIM: {student.nim || 'Tidak ada'}</span>
                        </div>
                        <div className="flex items-center gap-2">
                  ...
                  <div className="mt-4">
                    <p className="text-sm font-semibold text-gray-700 mb-2">Terdaftar di Kelas:</p>
                    <div className="flex flex-wrap gap-2">
                      {student.classes.map((classItem, idx) => (
                        <button
                          key={idx}
                          onClick={() => handleClassClick(classItem.classId)}
                          className="px-3 py-1 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 group"
                        >
