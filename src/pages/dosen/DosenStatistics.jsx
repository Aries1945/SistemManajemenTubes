  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Ringkasan statistik dari semua kelas yang Anda ajar</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-lg p-6 text-white">
          ...
          <p className="text-blue-100 text-sm mb-1">Total Kelas</p>
        ...
        <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl shadow-lg p-6 text-white">
          ...
          <p className="text-green-100 text-sm mb-1">Total Mahasiswa</p>
        ...
        <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl shadow-lg p-6 text-white">
          ...
          <p className="text-purple-100 text-sm mb-1">Total Tugas</p>
        ...
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl shadow-lg p-6 text-white">
          ...
          <p className="text-orange-100 text-sm mb-1">Perlu Dinilai</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-gray-100">
          ...
          <p className="text-gray-600 text-sm mb-1">Total Kelompok</p>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-gray-100">
          ...
          <p className="text-gray-600 text-sm mb-1">Rata-rata Progress</p>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-gray-100">
          ...
          <p className="text-gray-600 text-sm mb-1">Tugas Aktif</p>
      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-gray-100">
        ...
        {classStats.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">Belum ada kelas yang diajar</p>
          </div>
        ) : (
          <div className="grid gap-4">
            {classStats.map((classItem) => (
              <div
                ...
                className="bg-gradient-to-r from-gray-50 to-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-200 cursor-pointer"
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Mahasiswa</p>
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold text-orange-600">{classItem.pendingGrading}</p>
                  </div>
                </div>
              </div>
            ))}
